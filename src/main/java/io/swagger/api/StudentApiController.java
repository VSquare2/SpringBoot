...
public class StudentApiController implements StudentApi {
	...
	@GetMapping("/getStudentByPage/{num}")
    public ResponseEntity<Page<Student>> findStudentByPage(@Parameter(in = ParameterIn.PATH,  required=true, schema=@Schema())
    @PathVariable("num") int num){
    	
    	Page<Student> s=studentservice.findStudentByPage(num);
    	return new ResponseEntity<Page<Student>>(s, 
        		HttpStatus.OK);
	}
